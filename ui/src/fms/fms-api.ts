...
export interface paths {
    ...
    "/api/v1.0/fieldmonitor/get/GetLastPlayedMatch": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        get: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "text/plain": components["schemas"]["GuidNullableTournamentLevelNullableValueTuple"];
                        "application/json": components["schemas"]["GuidNullableTournamentLevelNullableValueTuple"];
                        "text/json": components["schemas"]["GuidNullableTournamentLevelNullableValueTuple"];
                    };
                };
            };
        };
        ...
        get: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "text/plain": {
                            [key: string]: components["schemas"]["MatchGroupView"];
                        };
                        "application/json": {
                            [key: string]: components["schemas"]["MatchGroupView"];
                        };
    ...
    "/api/v1.0/FTA/{season}/{eventCode}/appUsageData": {
        ...
        post: {
            parameters: {
                query?: never;
                header: {
                    "FMS-UsersRealName": string;
                    "FMS-DeviceIdentification": string;
                };
                path: {
                    season: number;
                    eventCode: string;
    ...
    "/api/v1.0/FTA/{season}/{eventCode}/eventNotes/{noteId}": {
        ...
        put: {
            ...
            requestBody?: {
                content: {
                    "application/json-patch+json": components["schemas"]["EventNoteCreateModifyModel"];
    ...
    "/api/v1.0/FTA/{season}/{eventCode}/matchNotes": {
        ...
        post: {
            ...
            requestBody?: {
                content: {
                    "application/json-patch+json": components["schemas"]["MatchNoteCreateModifyModel"];
                    "application/json": components["schemas"]["MatchNoteCreateModifyModel"];
                    "text/json": components["schemas"]["MatchNoteCreateModifyModel"];
                    "application/*+json": components["schemas"]["MatchNoteCreateModifyModel"];
                };
            };
            responses: {
    ...
    "/api/v1.0/FTA/{season}/{eventCode}/teamIssues": {
        ...
        post: {
            ...
            requestBody?: {
                content: {
                    "application/json-patch+json": components["schemas"]["TeamIssueCreateModifyModel"];
    ...
    "/hubs/FieldMonitorEvents/FieldMonitorPreviousMacAddressesChanged": {
        ...
        post: {
            parameters: {
                query?: {
                    data?: components["schemas"]["PreviousMacAddressesData"];
                };
                header?: never;
                path?: never;
                cookie?: never;
...
export interface components {
    schemas: {
        ...
        /** @description FTA Notepad: Create event note request */
        EventNoteCreateModifyModel: {
        ...
        FieldMonitorData: {
            ...
            radioConnectionQuality?: components["schemas"]["RadioConnectionQuality"] & unknown;
            /** @description MessagePack Key: pmm */
            radioConnectedToAp?: boolean;
            /** @description MessagePack Key: pnn */
            isEStopPressed?: boolean;
            /** @description MessagePack Key: poo */
        ...
        GuidNullableTournamentLevelNullableValueTuple: {
            /** Format: uuid */
            item1?: string | null;
            item2?: components["schemas"]["TournamentLevel"];
        };
        ...
        /** @description FTA Notepad: Create match note request */
        MatchNoteCreateModifyModel: {
            noteText?: string | null;
            tournamentLevel?: string | null;
            /** Format: int32 */
            matchNumber?: number;
        ...
        PreviousMacAddressesData: {
            /** @description MessagePack Key: p1 */
            red1MacAddress?: string | null;
            /** @description MessagePack Key: p2 */
            red2MacAddress?: string | null;
            /** @description MessagePack Key: p3 */
            red3MacAddress?: string | null;
            /** @description MessagePack Key: p4 */
            blue1MacAddress?: string | null;
            /** @description MessagePack Key: p5 */
            blue2MacAddress?: string | null;
            /** @description MessagePack Key: p6 */
            blue3MacAddress?: string | null;
        };
        /** @enum {string} */
        RadioConnectionQuality: RadioConnectionQuality;
        RankModel: {
            /** Format: int32 */
            rank?: number;
            /** Format: int32 */
        ...
        /** @description FTA Notepad: Team issue create or edit options */
        TeamIssueCreateModifyModel: {
            noteText?: string | null;
            tournamentLevel?: string | null;
            /** Format: int32 */
            matchNumber?: number;
...
export enum RadioConnectionQuality {
    Warning = "Warning",
    Caution = "Caution",
    Good = "Good",
    Excellent = "Excellent"
